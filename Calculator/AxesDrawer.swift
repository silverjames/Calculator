...
class AxesDrawer
{
    ...
    fileprivate enum AnchoredText
    {
        ...
        func drawAnchoredToPoint(_ location: CGPoint, color: UIColor) {
            let attributes = [
                kCTFontAttributeName : UIFont.preferredFont(forTextStyle: UIFontTextStyle.footnote),
                kCTForegroundColorAttributeName : color
            ]
            var textRect = CGRect(center: location, size: text.size(withAttributes: attributes as [NSAttributedStringKey : Any]))
            switch self {
